...
<div class="sktb-full-page-container">
    ...
    <p><?php esc_attr_e( 'Ready to import WordPress websites all made up using Elementor page builder. Be ready to import those Elementor templates into your existing website or fresh installs. Use the template blocks with your favourite themes whereas if you want to take the full juice out of those templates try SKT free themes. SKT Themes houses more than 250+ exciting designs and have been doling out updates to existing themes as well as fresh designs each year from 2013 and has a customer base from all over the world.', 'skt-templates' ); ?></p>
	<p><?php esc_attr_e( 'Check out our premium themes.', 'skt-templates' ); ?></p>	
    <p><a href="<?php echo esc_url('https://www.sktthemes.org/themes/');?>" target="_blank"><img src="<?php echo esc_url( SKTB_URL ); ?>/images/skt-template-banner.jpg" title="<?php echo esc_html( 'SKT Themes'); ?>"/></a></p>
	</div>
</div>

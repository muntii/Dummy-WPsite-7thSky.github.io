...
function jupiterx_full_width_template() {
	...
	if ( ! is_singular() || ! in_array( get_page_template_slug(), $full_width_templates, true ) ) {
		return;
	}

...
function jupiterx_enqueue_admin_scripts() {
	...
	wp_localize_script(
		...
		[
			...
			'important_notice_text'          => sprintf( '%<br><br><small>% <strong>%</strong>, % <strong>%</strong> %.</small>', __( 'Since Jupiter X v1.6.0, you will no longer need Jupiter X Pro plugin to be able to use premium features as we have moved those features to theme itself for a better user experience. Click the button down below to deactivate and delete the plugin from your site', 'jupiterx-lite' ), __( 'If the button does not work, please go to', 'jupiterx-lite' ), __( 'Plugins &gt; Installed Plugins', 'jupiterx-lite' ), __( 'deactivate and delete the', 'jupiterx-lite' ), __( 'Jupiter X Pro', 'jupiterx-lite' ), __( 'plugin', 'jupiterx-lite' ) ),

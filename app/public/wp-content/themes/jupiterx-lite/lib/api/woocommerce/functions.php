...
function jupiterx_wc_product_page_social_share() {
	...
	if ( in_array( 'social_share', $elements, true ) ) {
		jupiterx_post_social_share_shortcode( 'product_page', get_theme_mod( 'jupiterx_product_page_social_share_filter', [ 'email', 'facebook', 'twitter', 'pinterest', 'linkedin', 'reddit', 'digg' ] ), false );
	}
}

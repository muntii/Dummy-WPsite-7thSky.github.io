...
function jupiterx_search_page_secondary_title() {
	...
	jupiterx_open_markup_e( 'jupiterx_search_secondary_title', 'h3', [ 'class' => 'jupiterx-search-secondary-title' ] );
		...
		printf( '%1$s%2$s', jupiterx_output( 'jupiterx_search_secondary_title_text', esc_html__( 'Search results for: ', 'jupiterx-lite' ) ), get_search_query() ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped -- Pending security audit.

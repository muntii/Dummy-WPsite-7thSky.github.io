...
define('LAPTOP_REPAIR_SKTTHEMES_URL','https://www.sktthemes.org/','laptop-repair');
define('LAPTOP_REPAIR_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/laptop-repair-wordpress-theme/','laptop-repair');
define('LAPTOP_REPAIR_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-computer-store-wordpress-theme','laptop-repair');
define('LAPTOP_REPAIR_SKTTHEMES_THEME_DOC','https://sktthemesdemo.net/documentation/laptop-repair-documentation/','laptop-repair');
define('LAPTOP_REPAIR_SKTTHEMES_LIVE_DEMO','https://www.sktperfectdemo.com/demos/laptoprepair/','laptop-repair');
define('LAPTOP_REPAIR_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/','laptop-repair');
/**
